...
class StaticTableViewController: UITableViewController {
    ...
    var accountsMail : [Account] =
    [ //array of object Account
        /*>*/
        Account(name: "iCloud", folders: ["reception","new"]), // object
        Account(name: "Gmail",  folders: ["reception","new", "draft"])
    ]
...
//        }
//        return nil
                return accountsMail[section].name
    }
